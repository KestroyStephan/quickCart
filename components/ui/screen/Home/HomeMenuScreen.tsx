...
export  default  function HomeMenuScreen({navigation}:any){
    return(
        <View style={styles.container}>
            ...
            <Menu.Item leadingIcon="content-cut" onPress={() => {navigation.navigate('Vouchers')}} title="Vouchers"  />
            ...
            <Menu.Item leadingIcon="content-copy" onPress={() => {navigation.navigate('LatestProducts')}} title="Latest Products"  />
            <Menu.Item leadingIcon="content-paste" onPress={() => {navigation.navigate('Profile')}} title="Profile" />
            <Menu.Item leadingIcon="content-copy" onPress={() => {navigation.navigate('CustomerCare')}} title="Customer Care"  />
